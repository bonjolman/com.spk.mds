 ...
 * @author WILDAN
 */
public class Add_RatingKecocokan extends javax.swing.JFrame {

    /**
     * Creates new form Add_RatingKepentingan
     */
    String id = "A1";
    public Add_RatingKecocokan(String id) {
        initComponents();
        this.id = id;
        setTitle("Rating Kecocokan ID Alternatif : "+id);
        setStatusAlternatif();
        if(cekRating(id)) {
        ...
        setSelectedBobot(bobot_listC1,"C1",txt_id.getText());
        setSelectedBobot(bobot_listC2,"C2",txt_id.getText());
        setSelectedBobot(bobot_listC3,"C3",txt_id.getText());
        setSelectedBobot(bobot_listC4,"C4",txt_id.getText());
        setSelectedBobot(bobot_listC5,"C5",txt_id.getText());
        setSelectedBobot(bobot_listC6,"C6",txt_id.getText());
        setSelectedBobot(bobot_listC7,"C7",txt_id.getText());
        setSelectedBobot(bobot_listC8,"C8",txt_id.getText());
        setSelectedBobot(bobot_listC9,"C9",txt_id.getText());
        
        
    }
    
    public Add_RatingKecocokan() {
        initComponents();
        setTitle("Rating Kecocokan ID Alternatif : "+id);
        setStatusAlternatif();
        if(cekRating(id)) {
    ...
    public void setSelectedBobot(javax.swing.JComboBox cb, String idKriteria, String nis) {
        ...
        for(RelKriteriaAlternatif a:ResultList) {
            String id = getIdRelKriteriaAlternatif(idKriteria,nis);
    ...
    public void setStatusAlternatif() {
        List<Alternatif> ResultList = manager.createNamedQuery("Alternatif.findAll").getResultList();
        for(Alternatif a:ResultList) {
            if(a.getIdAlternatif().equals(id) && !id.equals("")) {
                txt_id.setText(a.getIdAlternatif());
                txt_nama.setText(a.getNama());
                txt_keterangan.setText(a.getKeterangan());
            }
        }
    }
    
    public boolean cekRating(String id) {
        List<RelKriteriaAlternatif> ResultList = manager.createNamedQuery("RelKriteriaAlternatif.findAll").getResultList();
        for(RelKriteriaAlternatif a:ResultList) {
    ...
    public boolean cekKriteriaAlternatif(String idKriteria, String id) {
        List<RelKriteriaAlternatif> ResultList = manager.createNamedQuery("RelKriteriaAlternatif.findAll").getResultList();
        for(RelKriteriaAlternatif a:ResultList) {
            if(a.getIdAlternatif().getIdAlternatif().equals(id) && a.getIdKriteria().getIdKriteria().equals(idKriteria)) {
                return true;
            }
        }
        return false;
    ...
    public String getIdRelKriteriaAlternatif(String idKriteria, String nis) {
        List<RelKriteriaAlternatif> ResultList = manager.createNamedQuery("RelKriteriaAlternatif.findAll").getResultList();
        for(RelKriteriaAlternatif a:ResultList) {
            if(a.getIdAlternatif().getIdAlternatif().equals(id) && a.getIdKriteria().getIdKriteria().equals(idKriteria)) {
                return a.getId();
    ...
    public void removeKriteriaAlternatif(String id) {
        EntityManager m = PersistenceHelper.getEntityManagerFactory().createEntityManager();
        m.getTransaction().begin();
        
        RelKriteriaAlternatif a = new RelKriteriaAlternatif(id);
        RelKriteriaAlternatif am = m.find(RelKriteriaAlternatif.class, a.getId());
    ...
    public void saveSettingKriteria(String idKriteria, String id, int b) {
        EntityManager m = PersistenceHelper.getEntityManagerFactory().createEntityManager();
        m.getTransaction().begin();
        try {
            RelKriteriaAlternatif data = new RelKriteriaAlternatif();
            data.setId(idKriteria+"_"+id);
            data.setIdKriteria(new Kriteria(idKriteria));
            data.setIdAlternatif(new Alternatif(id));
            String bobot = "";
            if(b == 0) {
                bobot = "L";
            }else if(b == 1) {
            ...
            if(!cekKriteriaAlternatif(idKriteria,id)) {
                m.persist(data);
                m.getTransaction().commit();
            }else {
                removeKriteriaAlternatif(getIdRelKriteriaAlternatif(idKriteria,id));
                m.persist(data);
                m.getTransaction().commit();
            }
        }catch(Exception ex) {
    ...
    private void initComponents() {
        ...
        paneRatingKec = new javax.swing.JPanel();
        ...
        javax.swing.GroupLayout paneRatingKecLayout = new javax.swing.GroupLayout(paneRatingKec);
        paneRatingKec.setLayout(paneRatingKecLayout);
        paneRatingKecLayout.setHorizontalGroup(
            paneRatingKecLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(paneRatingKecLayout.createSequentialGroup()
                .addContainerGap()
                .addGroup(paneRatingKecLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
        ...
        paneRatingKecLayout.setVerticalGroup(
            paneRatingKecLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(paneRatingKecLayout.createSequentialGroup()
                .addContainerGap()
        ...
        layout.setHorizontalGroup(
            ...
            .addComponent(paneRatingKec, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        );
        layout.setVerticalGroup(
            layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(paneRatingKec, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        );
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        saveSettingKriteria("C1",txt_id.getText(),C1);
        saveSettingKriteria("C2",txt_id.getText(),C2);
        saveSettingKriteria("C3",txt_id.getText(),C3);
        saveSettingKriteria("C4",txt_id.getText(),C4);
        saveSettingKriteria("C5",txt_id.getText(),C5);
        saveSettingKriteria("C6",txt_id.getText(),C6);
        saveSettingKriteria("C7",txt_id.getText(),C7);
        saveSettingKriteria("C8",txt_id.getText(),C8);
        saveSettingKriteria("C9",txt_id.getText(),C9);
        setStat(1);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Add_RatingKecocokan().setVisible(true);
            }
        });
    }

    // Variables declaration - do not modify//GEN-BEGIN:variables
    private javax.swing.JButton add_rating;
    ...
    public static javax.swing.JPanel paneRatingKec;
    private javax.swing.JPanel pane_kriteria;
