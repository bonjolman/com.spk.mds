 ...
 * @author WILDAN
 */
public class KriteriaModel extends Kriteria{
    ...
    public void insertData(Object data) {
        ...
        try {
            ...
            showMessage("Success insert into Table Kriteria");
        }catch(Exception ex) {
    ...
    public void removeData(String id) {
        ...
        Kriteria a = new Kriteria(id);
        Kriteria am = manager.find(Kriteria.class, a.getIdKriteria());
    ...
    public void getAllData() {
        ...
        for(Kriteria a:ResultList) {
            Object o[] = new Object[3];
            o[1] = a.getNamaKriteria();
            o[2] = a.getKeterangan();
            o[0] = a.getIdKriteria();
    ...
    public void getAllData(String query) {
        List<Kriteria> ResultList = manager.createNamedQuery(query).getResultList();
